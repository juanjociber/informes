  ...
  <head>
    ...
    <style>
      ...
      @media(min-width:768px){
        .contenedor-anexos{ grid-template-columns: 6fr 1fr;}
      ...
      <?php if ($isAuthorized): ?>
        ...
        <div class="row mb-3 border-bottom">
          <div class="col-12 col-md-3 mb-2">
            <button id="descripcion" class="btn btn-primary form-control fw-bold col-12" data-bs-toggle="modal" data-bs-target="#modalAnexo"><i class="fas fa-plus"></i> ANEXOS</button>
          </div>
        </div>
        ...
        <div class="mt-4">
          <?php foreach($archivos as $archivo): ?>
            <?php if ($archivo['tabla'] ==='INFA'): ?>
              <?php $contador+=1; ?>
              <div class="contenedor-anexos mb-2 cabecera-anexos--mod" style="margin:0 auto;">
                <div class="grid-actividad d-flex align-items-center p-1 cabecera-anexos">
                <div class>ANEXO</div></span><span>&nbsp;- </span>
                  <span class="text-secondary" style="font-size:17px !important"><?php echo $contador ?>
                </div>
