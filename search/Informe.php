    ...
    <div class="container section-top">
      ...
      <div class="row border-bottom mb-2 fs-5">
        <div class="col-12 fw-bold d-flex justify-content-between">
          <p class="m-0"><?php echo $isAuthorized ? $ClienteNombre : ''; ?></p>
          <input type="text" class="d-none" id="idInforme" value="<?php echo $ID;?>">
          <p class="m-0"><?php echo $isAuthorized ? $Nombre :'' ; ?></p>
        </div>
      </div>
      ...
      <?php if ($isAuthorized): ?>
        ...
        <div class="row p-1 mb-2 mt-2">
          ...
          <div class="row p-1 m-0">
            ...
            <div class="row m-0 mt-2 mb-2 p-0 d-flex justify-content-center">
              <?php foreach($imagenInformes as $imagenInforme): ?>
                <div class="col-5 col-lg-4 col-xl-3 m-1 border border-secondary border-opacity-50">
                  <p class="text-center mt-4 mb-1"><?php echo ($imagenInforme['titulo']); ?></p>
                  <img src="/mycloud/gesman/files/<?php echo ($imagenInforme['nombre']); ?>" class="img-fluid" alt="">
                  <p class="text-center"><?php echo ($imagenInforme['descripcion']); ?></p>
                </div>
              <?php endforeach; ?>
            </div>
          </div>
          ...
          <div class="row p-1 m-0">
            <div class="row m-0 mt-2 mb-2 p-0 d-flex justify-content-center">
              <?php foreach($imagenAnexos as $imagenAnexo): ?>
                  <div class="col-12 col-md-10 col-xl-8 mb-4 m-1 border border-secondary border-opacity-50" style="text-align:center;">
                    <p class="text-center mt-4 mb-1"><?php echo ($imagenAnexo['titulo']); ?></p>
                    <img src="/mycloud/gesman/files/<?php echo ($imagenAnexo['nombre']); ?>" class="img-fluid" alt="">
                    <p class="text-center"><?php echo ($imagenAnexo['descripcion']); ?></p>
                  </div>
              <?php endforeach; ?>
            </div>
          </div>
